 ...
 * Slug: jr26-experiments/single-gatherpress_venue
 * Inserter: no
 */
?>
...
<div class="wp-block-group alignfull" style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:gatherpress/event-date {"displayType":"start","startDateFormat":"d. F Y","showTimezone":"no","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-4"}}}},"textColor":"accent-4","fontSize":"small"} /-->
